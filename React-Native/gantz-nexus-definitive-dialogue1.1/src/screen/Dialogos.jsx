...
const Main = ({navigation})=>{
    ...
    return (
        <>
            ...
            <View style={{...EstilosDialogos.RecuadroDialogo, opacity: DialogosOpacidad}}>
                <Text style={{...EstilosDialogos.Nombre, color: ColorNombre}}>{Nombre}</Text>
                <Text
                ...
                <AntDesign name="caretright" size={26} color="white" style={{...EstilosDialogos.FlechaDecisionA,opacity:IconoOpcionAOpacidad}} />
                <AntDesign name="caretright" size={26} color="white" style={{...EstilosDialogos.FlechaDecisionB,opacity:IconoOpcionBOpacidad}} />
            </View>
            <TouchableWithoutFeedback
                onPress={Inicio}
